...
Route::controller(AnimController::class)->group(function(){
    ...
    Route::post('/profiles/{profile}/anims/insert', 'insert')->name('anim.insert');   //既存のanimsテーブル内のレコードにデータを渡し、保存
    ...
    Route::get('/profiles/{profile}/anims/select/complete', 'complete')->name('anim.complete');   //選んだアニメを表示する画面に遷移
